...
public class CustoServicoV2Test {

    @Test
    @DisplayName("RS: sem promo, faixa baixa (<100)")
    void rsSemPromoFaixaBaixa() {
        var dto = CustoServicoV2.calculaCustoServico(50, 1, Promocao.SEMPROMO, Estado.RS);
    ...
    void rsPrimeiraCompraFaixaMedia() {
        var dto = CustoServicoV2.calculaCustoServico(250, 2, Promocao.PRIMEIRACOMPRA, Estado.RS); // bruto=500
    ...
    void rsBlackFridayFaixaAlta() {
        var dto = CustoServicoV2.calculaCustoServico(1000, 2, Promocao.BLACKFRIDAY, Estado.RS); // bruto=2000
    ...
    void scSemPromo() {
        var dto = CustoServicoV2.calculaCustoServico(300, 3, Promocao.SEMPROMO, Estado.SC); // bruto=900
    ...
    void scBlackFriday() {
        var dto = CustoServicoV2.calculaCustoServico(400, 4, Promocao.BLACKFRIDAY, Estado.SC); // bruto=1600
