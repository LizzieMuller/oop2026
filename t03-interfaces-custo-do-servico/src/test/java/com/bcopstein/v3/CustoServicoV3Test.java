...
public class CustoServicoV3Test {

    @Test
    @DisplayName("RS: sem promo, faixa baixa (<100)")
    void rsSemPromoFaixaBaixa() {
        var cs = new CustoServicoV3();
        var dto = cs.calculaCustoServico(50, 1, Promocao.SEMPROMO, Estado.RS);
    ...
    void rsPrimeiraCompraFaixaMedia() {
        var cs = new CustoServicoV3();
        var dto = cs.calculaCustoServico(250, 2, Promocao.PRIMEIRACOMPRA, Estado.RS); // bruto=500
    ...
    void rsBlackFridayFaixaAlta() {
        var cs = new CustoServicoV3();
        var dto = cs.calculaCustoServico(1000, 2, Promocao.BLACKFRIDAY, Estado.RS); // bruto=2000
    ...
    void scSemPromo() {
        var cs = new CustoServicoV3();
        var dto = cs.calculaCustoServico(300, 3, Promocao.SEMPROMO, Estado.SC); // bruto=900
    ...
    void scBlackFriday() {
        var cs = new CustoServicoV3();
        var dto = cs.calculaCustoServico(400, 4, Promocao.BLACKFRIDAY, Estado.SC); // bruto=1600
